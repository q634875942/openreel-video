...
// not depend on openreel's clip / timeline systems. The AI panel uses
// this for its in-panel preview; the production renderer integration
// (carry-over from feat-002) will reuse the same logic.

import type { SceneDescription, Shape } from "../../objects/SceneDescription";
